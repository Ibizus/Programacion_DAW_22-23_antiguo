...
public class ContarFrases { // dado un texto, trocearlo en frases
    ...
    public static void main(String[] args) {
        ...
        // Lo cortamos por cada punto y creamos un Array con las frases
        String[] frases = texto.split("\\.");

        // Medimos el array, la cantidad de frases
        int cantidadFrases = frases.length;

        // Lo muestro por pantalla:
        System.out.println("El texto contiene \"" + cantidadFrases + "\" frases.");

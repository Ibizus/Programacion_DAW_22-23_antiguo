...
public class EjString5y10 {
    public static void main(String[] args) {
        
        String texto = "En un lugar de la Mancha, de cuyo nombre no quiero acordarme, no ha mucho tiempo que "+
        ...
        "se deja entender que se llamaba «Quijana». Pero esto importa poco a nuestro cuento: basta "+
        "que en la narración dél no se salga un punto de la verdad.";

        String textoBuscado = "de";

        String[] partes = texto.split(textoBuscado);

        int numPartes = partes.length;

        System.out.println("La cadena "+textoBuscado+" aparece "+numPartes+" veces.");
